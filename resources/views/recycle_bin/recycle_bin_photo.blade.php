                                ...
                                @foreach($recycle_photo as $rp)
                                    <tr>
                                        ...
                                        <td><?php
                                                ...
                                                ?></td>
                                        <td><a href="/recycle_bin/photo/restore/{{$rp->id_photo}}"><i class="fa-solid fa-trash-can-arrow-up"></i></a></td>
                                        <td><a href="/recycle_bin/product/delete/{{$rp->id_photo}}"><i class="fa-solid fa-trash"></i></a></td>
                                    </tr>
                                @endforeach
                            </table>
