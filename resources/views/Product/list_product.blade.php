...
<section id="main-content">
    <section class="wrapper">
        <div class="table-agile-info" style="height: 85vh;">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped b-t b-light">
                        ...
                        <tr id="product_ids{{$row->id_product}}">
                            <td><input type="checkbox" name="ids[]" class="checkbox_ids" value="{{$row->id_product}}"></td>
                            <td>{{$i++}}</td>
                            ...
                            <td>
                                <a href="{{url('/edit_product/'.$row->id_product)}}" class="active" ui-toggle-class=""><i class="fas fa-edit"> </i>
                                </a>
                                <a href="{{url('/delete_product/'.$row->id_product)}}" onclick="return confirm('Are you want to delete product?')">
