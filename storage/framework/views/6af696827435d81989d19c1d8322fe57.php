            ...
            <section class="wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="row">
                            <h3 style="text-transform: uppercase; font-size: 3rem; text-align: center">Name product</h3>
                        </div>
                        <div class="row">
                ...
                <div class="row">
                    <div class="row">
                        <h3 style="text-transform: uppercase; text-align: center">the most user feedback</h3>
                    </div>
