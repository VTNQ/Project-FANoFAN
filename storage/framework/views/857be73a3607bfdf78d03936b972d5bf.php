    ...
    <?php $__currentLoopData = $photo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            <div class="col-12 col-md-4 mb-4">
                <div class="card ">
                    <a href="#">
                        <img src="/upload/<?php echo e($row->value); ?>" class="card-img-top" alt="..." >
                    </a>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Phong\Documents\project-FANoFAN\resources\views/index/index.blade.php ENDPATH**/ ?>