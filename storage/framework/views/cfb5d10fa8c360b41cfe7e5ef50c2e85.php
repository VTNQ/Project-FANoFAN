         ...
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active  dropdown px-lg-2 py-lg-0 py-md-1 py-sm-1 text-center  mx-auto">
               ...
               <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <a class="dropdown-item ceiling-fans-link waves-effect waves-light" href="/categories_list/<?php echo e($row->id); ?>"><?php echo e($row->name); ?></a>
...
</html><?php /**PATH C:\Users\Phong\Downloads\project-FANoFAN\resources\views/layouts/template3.blade.php ENDPATH**/ ?>