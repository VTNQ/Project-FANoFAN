            ...
            <button href="" class="btn btn-danger" id="btn-confirm">Delete Multiple</button>
                        ...
                        <table class="table table-striped b-t b-light">
                            ...
                            <?php $__currentLoopData = $list_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td><input type="checkbox" name="ids" class="checkbox_ids" value="<?php echo e($row->id_product); ?>"></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Phong\project-FANoFAN\resources\views/product/list_product.blade.php ENDPATH**/ ?>