                    ...
                    <div class="card h-100" style="height: 52vh">
                        <div class="flex-column" style="width: 400px; height:300px">
                            <a href="#" style="height: 10%">
                                <img src="<?php echo e($row->value); ?>" class="card-img-top" alt="..." style="height: 50vh">
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-FANoFAN\resources\views/index/search.blade.php ENDPATH**/ ?>