            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    <a href="/Product/<?php echo e($row->id_product); ?>">
                        <img src="<?php echo e($row->value); ?>" width="600" height="600" class="img-fluid img-thumbnail" alt="...">
                    </a>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-FANoFAN\resources\views/user/Home.blade.php ENDPATH**/ ?>